...
CREATE TABLE IF NOT EXISTS `P6`.`Product` (
  ...
  INDEX `fk_product_class_idx` (`product_type_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `P6`.`Product_recipe` (
  ...
  INDEX `fk_ingredient_id_idx` (`stock_ingredient_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `P6`.`OCPizza_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `P6`.`OCPizza_role` (
  `ocpizza_role_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `ocpizza_role_name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`ocpizza_role_id`),
  UNIQUE INDEX `role_id_UNIQUE` (`ocpizza_role_id` ASC) VISIBLE,
  UNIQUE INDEX `role_name_UNIQUE` (`ocpizza_role_name` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `P6`.`Order_StatusUpdate` (
  ...
  INDEX `fk_statusupdate_user_id_idx` (`status_update_user_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_statusupdate_user_id`
    FOREIGN KEY (`status_update_user_id`)
    REFERENCES `P6`.`User` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `P6`.`Ingredient_stock` (
  ...
  INDEX `fk_stock_restaurant_id_idx` (`restaurant_id` ASC) VISIBLE,
...
-- Table `P6`.`OCPizza`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `P6`.`OCPizza` (
  ...
  INDEX `fk_ocpizza_role_idx` (`ocpizza_role_id` ASC) VISIBLE,
  INDEX `fk_ocpizza_restaurant_idx` (`ocpizza_restaurant_id` ASC) VISIBLE,
  CONSTRAINT `fk_ocpizza_role`
    FOREIGN KEY (`ocpizza_role_id`)
    REFERENCES `P6`.`OCPizza_role` (`ocpizza_role_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ocpizza_user`
    FOREIGN KEY (`ocpizza_user_id`)
    REFERENCES `P6`.`User` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ocpizza_restaurant`
    FOREIGN KEY (`ocpizza_restaurant_id`)
    REFERENCES `P6`.`Restaurant` (`restaurant_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
